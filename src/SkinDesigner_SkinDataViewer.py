...
Use this component to extract from a SkinGenerator solution overall panel Ids and their locations as well as a range of panel properties as breps.
    ...
    Args:
        ...
        layerNameFilter: A string that indicates the panel elements layer that will be included in the output data. By default all the element layers in the SkinGeneraotr solution are included.
    ...
    for panel in bayData_Copy:
        ...
        if nameList.count(panelName):
            ...
            if drawPanelElements == True:
                ...
                if geoList <> []:
                    for geo in geoList: 
                        if layerNameFilter <> None and geo.GetUserString("Layer") <> layerNameFilter :
                            continue
                        customGeo.append(geo.Duplicate())
